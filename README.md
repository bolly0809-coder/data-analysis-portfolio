...
| # | 영역 | 경험 근거 | 핵심 역량 |
|---:|---|---|---|
| 1 | **Data Preparation & Validation** | 원본 화장품 행동 로그 874만 건 → 품질 점검 후 826만 건, 고객 단위 재구성 | 대용량 분할 로딩, 중복·무효값 처리, 관측 단위 설계, 고객 단위 분석 테이블 구축 |
...
| # | 프로젝트 | 규모·핵심 결과 | 연도 · 유형 |
|---:|---|---|:---:|
| 01 | [화장품 이커머스 장바구니 7일 구매 전환 분석](./cosmetics-cart-conversion-analysis) | 원본 로그 874만 건 → 품질 점검 후 826만 건 · 고객 108,458명 · 상위 10% 누적 리프트 1.46배 | 2026 · 2인 |
| 02 | [기업 리뷰·채용공고 지원 우선순위 분석](./job-review-analysis) | 수집 리뷰 29,680건 → 점수화 21,197건 · 7개 영역 · 채용공고 515건 우선순위화 | 2026 · 6인 |
| 03 | [서울시 생애주기별 사회적 고립 위험지역 분석](./seoul-isolation-risk-analysis) | 행정동 426개 중 완전 사례 378개 분석 · 전생애 중첩위험 지역 TOP9 도출 | 2026 · 2인 |

### 개인 분석 프로젝트 — 공개 데이터 기반

| # | 프로젝트 | 규모·핵심 결과 | 연도 · 유형 |
|---:|---|---|:---:|
| 04 | [캘리포니아 주택가격 예측](./california-housing-price-prediction) | CatBoost 평가 R² 0.785 · 로그 가격 RMSE 0.2659 · SHAP으로 주요 변수 해석 | 2026 · 개인 |
| 05 | [다이아몬드 가격 결정요인 분석](./diamonds-price-analysis) | 원본 가격 척도 R² 0.960 · RMSE 796.879달러 · 18개 회귀항으로 간명화 | 2026 · 개인 |
| 06 | [Mall Customers 고객 세분화](./mall-customers-segmentation) | 고객 200명을 5개 군집으로 세분화 · 평균 실루엣 0.555 · 경계 사례 6명 확인 | 2026 · 개인 |
| 07 | [의료보험 청구비용 결정요인 분석](./insurance-cost-analysis) | 원본 비용 척도 R² 0.750 · RMSE 6,058.642달러 · 흡연 여부가 가장 큰 조건부 관계 | 2026 · 개인 |
| 08 | [보스턴 주택가격 결정요인 분석](./boston-housing-analysis) | 원본 가격 척도 R² 0.777 · RMSE 4.336천 달러 · 로그변환으로 기준선 오차 개선 | 2026 · 개인 |
| 09 | [사과 품질 분류](./apple-quality-classification) | ROC-AUC 0.868 · 임계값 0.4/0.5/0.7에 따른 FP·FN 변화 비교 | 2026 · 개인 |
| 10 | [타이타닉 생존 예측](./titanic-survival-analysis) | F1 1위 KNN 0.773 · LogLoss 1위 RandomForest 0.433으로 평가 목적별 차이 확인 | 2026 · 개인 |
