...
서비스 분석에서 자주 사용되는 퍼널, 전환율, 리텐션, 이벤트 로그 분석 SQL을 연습하기 위해 만든 가상 데이터셋입니다.
...
이 케이스는 실제 특정 회사의 내부 데이터를 분석한 것이 아니라, 서비스 분석에서 필요한 지표 정의와 SQL 집계 구조를 보여주기 위한 자료입니다.
...
이 폴더는 기존 프로젝트에서 설명한 SQL 역량을 직접 확인할 수 있도록 만든 보강 자료입니다.
